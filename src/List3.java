...
public class List3<T> extends ListSecondary<T> {
    ...
    public List3() {
        ...
        // Call the create new rep method
        this.createNewRep();
    ...
    public final void addRightFront(T x) {
        ...
        // Declare new node and assign data
        Node n = new Node();
        n.data = x;

        // Make the next node after last left hook up with n
        n.next = this.lastLeft.next;
        n.next.previous = n;

        // Hook up n and the last left
    ...
    public final T removeRightFront() {
        ...
        // Assign result node as the next node of last left
        Node r = this.lastLeft.next;

        // Hook up last left with the node after result
        this.lastLeft.next = r.next;
    ...
    public final void advance() {
        ...
        // Make last left transitions
        this.lastLeft = this.lastLeft.next;

        // decrement right length and increment left length
        this.rightLength--;
        this.leftLength++;
    ...
    public final void moveToStart() {
        ...
        // Make last left transition
        this.lastLeft = this.preStart;

        // Change the length to approriate one
